...
function makePac() 
{
  ...
  // TODO: set position here - isnt position already initialized on line 21?
...
function checkCollisions(item) 
{
  ...
  // would return a new velocity?
  //would need to check the position of the pacmen with the pageWidth and see if it >=
